_base_ = [
    '../_base_/datasets/drone_vehicle.py', '../_base_/schedules/schedule_2x.py',
...
dataset_type = 'DroneVehicleIRDataset'
data_root = 'D:/Imanity/dev/Data/DroneVehicle/DroneVehicle_VOCdevkit/VOC2012/'
img_norm_cfg = dict(
